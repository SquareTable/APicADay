                    ...
                    :
                        <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
                            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                                ...
                                <TextInput style={{borderWidth: 1, width: 200, height: 35, marginTop: 10, color: colors.text, borderColor: colors.text, paddingLeft: 5, borderRadius: 5}} placeholder="Enter Password" placeholderTextColor={colors.text} value={enterPassword} onChangeText={changeEnterPassword} secureTextEntry/>
                                {passwordView === 'Enabling' && <TextInput style={{borderWidth: 1, width: 200, height: 35, marginTop: 10, color: colors.text, borderColor: colors.text, paddingLeft: 5, borderRadius: 5}} placeholder='Confirm Password' placeholderTextColor={colors.text} value={confirmPassword} onChangeText={changeConfirmPassword} secureTextEntry/>}
